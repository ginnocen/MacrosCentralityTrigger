...
//TString option=Form("CentLim_%d_%d_%d_%d_%d_8July2014",limit0,limit1,limit2,limit3,limit4);
TString option="CentLim_10_20_60_100_140_8July2014_MC";

void plot(bool isdata=false)
{//CalibrationEtsum_CentLim_10_20_60_100_140_8July2014_MC.root

...
void makePrettyTurnOn()
{
  ...
  TFile *inFile = TFile::Open("../Input/Data/CalibrationEtsum_CentLim_10_20_60_100_140_8July2014.root");
  ...
  c1->SaveAs("Plots/Plots_CentLim_10_20_60_100_140_8July2014/TurnOnCurveCentrality.pdf");
